...
var paths = {
  'stylesheetsEntryPoint': 'source/stylesheets/flekstub.scss',
  'stylesheets': 'source/stylesheets/**/*.scss',
  'stylesheetsDist': './flekstub/css/',

  'fontsEntryPoint': '/source/stylesheets/fonts/**.*',
  'fontsDist': 'flekstub/fonts',

  'views': 'source/**/*.slim',

  'imageEntryPoint': 'source/images/**/*.+(png|jpg|jpeg|gif|svg)',
  'imageDist': './flekstub/images',

  'javascriptMainFile': 'flekstub.js',
  'javascriptsEntryPoint': './source/javascripts/',
  'javascriptsDist': './flekstub/javascripts/'
  // 'buildFolder': 'build'
};
...
gulp.task('stylesheets',function() {
  ...
  // Compiles CSS
  var postPlugins = [ // add PostCssPlugins
    'flexibility',
  ];
